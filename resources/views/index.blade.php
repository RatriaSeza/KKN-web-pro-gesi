<x-layouts.app>
    <x-slot:title>
        ...
        <div class="jos bg-white py-10 relative -top-14 md:max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-7 md:mx-auto shadow-md z-10 rounded-md"
        ...
        <div class="jos"
            ...
            <div
                class="flex flex-col md:flex-row items-center justify-center gap-6 md:max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-7 md:mx-auto">
                @for ($i = 0; $i < 3; $i++)
                    <div
                        class="bg-white max-w-full md:max-w-xs rounded overflow-hidden shadow-[0_3px_5px_rgb(0,0,0,0.2)]">
                        <img class="w-full h-40 object-cover" src="{{ asset('img/carousel/kantor-lurah.jpg') }}"
                            alt="Kantor Lurah">
                        <div class="px-4 py-3">
        ...
        <div class="py-10 md:py-20 md:max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-7 md:mx-auto">
            <div
                ...
                <div class="demo-container jos" data-jos_animation="fade-right"
                ...
                <div class="border-4 shadow-[0_3px_10px_rgb(0,0,0,0.2)] border-white rounded demo-container jos"
                    data-jos_animation="fade-left" data-jos_delay="0.5"
                    data-jos_timing-function="ease-in-out">
                    <iframe class="mx-auto w-full md:w-[600px] h-80 md:h-[450px]"
