<x-layouts.app>
    <x-slot:title>
        ...
        <div>
            <p class="mb-4 md:mb-0 md:my-10 text-center text-2xl font-semibold">Berita</p>
        ...
        <div class="flex flex-col md:flex-row justify-between max-w-5xl mx-7 md:mx-auto py-10 md:py-20 gap-5 md:gap-10">
            <div class="">
                <div class="text-sky-500 font-Secondary font-black text-5xl md:text-6xl mb-3 drop-shadow">
                    Lokasi
                </div>
